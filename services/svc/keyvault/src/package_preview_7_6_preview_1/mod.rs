...
impl Client {
    ...
    pub fn full_backup(&self) -> full_backup::RequestBuilder {
        full_backup::RequestBuilder {
            client: self.clone(),
            azure_storage_blob_container_uri: None,
        }
    }
    #[doc = "Pre-backup operation for checking whether the customer can perform a full backup operation."]
    pub fn pre_full_backup(&self) -> pre_full_backup::RequestBuilder {
        pre_full_backup::RequestBuilder {
            client: self.clone(),
            pre_backup_operation_parameters: None,
        }
    }
    ...
    pub fn full_backup_status(&self, job_id: impl Into<String>) -> full_backup_status::RequestBuilder {
        full_backup_status::RequestBuilder {
            client: self.clone(),
            job_id: job_id.into(),
        }
    }
    #[doc = "Pre-restore operation for checking whether the customer can perform a full restore operation."]
    pub fn pre_full_restore_operation(&self) -> pre_full_restore_operation::RequestBuilder {
        pre_full_restore_operation::RequestBuilder {
            client: self.clone(),
            pre_restore_operation_parameters: None,
        }
    }
    #[doc = "Restores all key materials using the SAS token pointing to a previously stored Azure Blob storage backup folder"]
    pub fn full_restore_operation(&self) -> full_restore_operation::RequestBuilder {
        full_restore_operation::RequestBuilder {
            client: self.clone(),
    ...
    pub fn restore_status(&self, job_id: impl Into<String>) -> restore_status::RequestBuilder {
        restore_status::RequestBuilder {
            client: self.clone(),
            job_id: job_id.into(),
        }
    }
    ...
    pub fn selective_key_restore_operation(&self, key_name: impl Into<String>) -> selective_key_restore_operation::RequestBuilder {
        selective_key_restore_operation::RequestBuilder {
            client: self.clone(),
    ...
    pub fn rotate_key(&self, key_name: impl Into<String>) -> rotate_key::RequestBuilder {
        rotate_key::RequestBuilder {
            client: self.clone(),
            key_name: key_name.into(),
        }
    }
    ...
    pub fn get_key_rotation_policy(&self, key_name: impl Into<String>) -> get_key_rotation_policy::RequestBuilder {
        get_key_rotation_policy::RequestBuilder {
            client: self.clone(),
            key_name: key_name.into(),
        }
    }
    ...
    ) -> update_key_rotation_policy::RequestBuilder {
        update_key_rotation_policy::RequestBuilder {
            client: self.clone(),
            key_name: key_name.into(),
    ...
    pub fn get_random_bytes(&self, parameters: impl Into<models::GetRandomBytesRequest>) -> get_random_bytes::RequestBuilder {
        get_random_bytes::RequestBuilder {
            client: self.clone(),
            parameters: parameters.into(),
        }
    }
    ...
    #[doc = "Get specified account setting object."]
    #[doc = "Retrieves the setting object of a specified setting name."]
    #[doc = ""]
    #[doc = "Arguments:"]
    #[doc = "* `setting_name`: The name of the account setting. Must be a valid settings option."]
    pub fn get_setting(&self, setting_name: impl Into<String>) -> get_setting::RequestBuilder {
        get_setting::RequestBuilder {
            client: self.clone(),
            setting_name: setting_name.into(),
        }
    }
    #[doc = "Updates key vault account setting, stores it, then returns the setting name and value to the client."]
    #[doc = "Description of the pool setting to be updated"]
    #[doc = ""]
    #[doc = "Arguments:"]
    #[doc = "* `setting_name`: The name of the account setting. Must be a valid settings option."]
    #[doc = "* `parameters`: The parameters to update an account setting."]
    pub fn update_setting(
        &self,
        setting_name: impl Into<String>,
        parameters: impl Into<models::UpdateSettingRequest>,
    ) -> update_setting::RequestBuilder {
        update_setting::RequestBuilder {
            client: self.clone(),
            setting_name: setting_name.into(),
            parameters: parameters.into(),
    ...
    #[doc = "List account settings."]
    #[doc = "Retrieves a list of all the available account settings that can be configured."]
    pub fn get_settings(&self) -> get_settings::RequestBuilder {
        get_settings::RequestBuilder { client: self.clone() }
    }
...
pub mod full_backup {
    ...
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::FullBackupOperation> {
            ...
            let body: models::FullBackupOperation = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            ...
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
            }
            Ok(url)
        }
    }
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::FullBackupOperation>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::FullBackupOperation>>;
...
pub mod pre_full_backup {
    ...
    pub struct RequestBuilder {
        pub(crate) client: super::Client,
        pub(crate) pre_backup_operation_parameters: Option<models::PreBackupOperationParameters>,
    }
    impl RequestBuilder {
        #[doc = "Optional parameters to validate prior to performing a full backup operation."]
        pub fn pre_backup_operation_parameters(
            mut self,
            pre_backup_operation_parameters: impl Into<models::PreBackupOperationParameters>,
        ) -> Self {
            self.pre_backup_operation_parameters = Some(pre_backup_operation_parameters.into());
            self
        }
        #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
        #[doc = ""]
        ...
        pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
            Box::pin({
                ...
                async move {
                    ...
                    let bearer_token = this.client.bearer_token().await?;
                    req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                    let req_body = if let Some(pre_backup_operation_parameters) = &this.pre_backup_operation_parameters {
                        req.insert_header("content-type", "application/json");
                        azure_core::to_json(pre_backup_operation_parameters)?
                    } else {
                        azure_core::EMPTY_BODY
                    };
                    req.set_body(req_body);
...
pub mod full_backup_status {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/backup/{}/pending", &self.job_id));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod pre_full_restore_operation {
    use super::models;
    #[cfg(not(target_arch = "wasm32"))]
    use futures::future::BoxFuture;
    #[cfg(target_arch = "wasm32")]
    ...
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::RestoreOperation> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::RestoreOperation = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    pub struct RequestBuilder {
        pub(crate) client: super::Client,
        pub(crate) pre_restore_operation_parameters: Option<models::PreRestoreOperationParameters>,
    }
    impl RequestBuilder {
        #[doc = "Optional pre restore parameters to validate prior to performing a full restore operation."]
        pub fn pre_restore_operation_parameters(
            mut self,
            pre_restore_operation_parameters: impl Into<models::PreRestoreOperationParameters>,
        ) -> Self {
            self.pre_restore_operation_parameters = Some(pre_restore_operation_parameters.into());
            self
        }
        #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
        #[doc = ""]
        ...
        pub fn send(self) -> BoxFuture<'static, azure_core::Result<Response>> {
            Box::pin({
                ...
                async move {
                    ...
                    let bearer_token = this.client.bearer_token().await?;
                    req.insert_header(azure_core::headers::AUTHORIZATION, format!("Bearer {}", bearer_token.secret()));
                    let req_body = if let Some(pre_restore_operation_parameters) = &this.pre_restore_operation_parameters {
                        req.insert_header("content-type", "application/json");
                        azure_core::to_json(pre_restore_operation_parameters)?
                    } else {
                        azure_core::EMPTY_BODY
                    };
                    req.set_body(req_body);
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/prerestore",));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::RestoreOperation>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::RestoreOperation>>;
        #[doc = "Returns a future that polls the long running operation, returning once the operation completes."]
        #[doc = ""]
        #[doc = "To only submit the request but not monitor the status of the operation until completion, use `send()` instead."]
        #[doc = ""]
...
pub mod restore_status {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/restore/{}/pending", &self.job_id));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod selective_key_restore_operation {
    ...
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::SelectiveKeyRestoreOperation> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::SelectiveKeyRestoreOperation = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/keys/{}/restore", &self.key_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::SelectiveKeyRestoreOperation>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::SelectiveKeyRestoreOperation>>;
        #[doc = "Returns a future that polls the long running operation, returning once the operation completes."]
        #[doc = ""]
        #[doc = "To only submit the request but not monitor the status of the operation until completion, use `send()` instead."]
        #[doc = ""]
...
pub mod delete_certificate {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/certificates/{}", &self.certificate_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::DeletedCertificateBundle>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::DeletedCertificateBundle>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod get_certificate_contacts {
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::Contacts>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::Contacts>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod get_certificate_issuer {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/certificates/issuers/{}", &self.issuer_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::IssuerBundle>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::IssuerBundle>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod create_certificate {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/certificates/{}/create", &self.certificate_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::CertificateOperation>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::CertificateOperation>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod import_certificate {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/certificates/{}/import", &self.certificate_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::CertificateBundle>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::CertificateBundle>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod get_certificate_versions {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/certificates/{}/versions", &self.certificate_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod get_certificate_policy {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/certificates/{}/policy", &self.certificate_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::CertificatePolicy>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::CertificatePolicy>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod get_certificate {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/certificates/{}/{}", &self.certificate_name, &self.certificate_version));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod get_certificate_operation {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/certificates/{}/pending", &self.certificate_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod merge_certificate {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/certificates/{}/pending/merge", &self.certificate_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod backup_certificate {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/certificates/{}/backup", &self.certificate_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::BackupCertificateResult>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::BackupCertificateResult>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod get_deleted_certificate {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/deletedcertificates/{}", &self.certificate_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod recover_deleted_certificate {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/deletedcertificates/{}/recover", &self.certificate_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod create_key {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/keys/{}/create", &self.key_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::KeyBundle>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::KeyBundle>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod rotate_key {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/keys/{}/rotate", &self.key_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod import_key {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/keys/{}", &self.key_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod delete_key {
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::DeletedKeyBundle>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::DeletedKeyBundle>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod get_key {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/keys/{}/{}", &self.key_name, &self.key_version));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod get_key_versions {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/keys/{}/versions", &self.key_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod backup_key {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/keys/{}/backup", &self.key_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::BackupKeyResult>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::BackupKeyResult>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod encrypt {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/keys/{}/{}/encrypt", &self.key_name, &self.key_version));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::KeyOperationResult>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::KeyOperationResult>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod decrypt {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/keys/{}/{}/decrypt", &self.key_name, &self.key_version));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod sign {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/keys/{}/{}/sign", &self.key_name, &self.key_version));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod verify {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/keys/{}/{}/verify", &self.key_name, &self.key_version));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::KeyVerifyResult>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::KeyVerifyResult>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod wrap_key {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/keys/{}/{}/wrapkey", &self.key_name, &self.key_version));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod unwrap_key {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/keys/{}/{}/unwrapkey", &self.key_name, &self.key_version));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod release {
    ...
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::KeyReleaseResult> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::KeyReleaseResult = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/keys/{}/{}/release", &self.key_name, &self.key_version));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::KeyReleaseResult>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::KeyReleaseResult>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod get_deleted_key {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/deletedkeys/{}", &self.key_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod recover_deleted_key {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/deletedkeys/{}/recover", &self.key_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod get_key_rotation_policy {
    ...
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::KeyRotationPolicy> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::KeyRotationPolicy = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/keys/{}/rotationpolicy", &self.key_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::KeyRotationPolicy>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::KeyRotationPolicy>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod get_random_bytes {
    ...
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::RandomBytes> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::RandomBytes = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::RandomBytes>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::RandomBytes>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod set_secret {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/secrets/{}", &self.secret_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::SecretBundle>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::SecretBundle>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod delete_secret {
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::DeletedSecretBundle>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::DeletedSecretBundle>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod get_secret {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/secrets/{}/{}", &self.secret_name, &self.secret_version));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod get_secret_versions {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/secrets/{}/versions", &self.secret_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod get_deleted_secret {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/deletedsecrets/{}", &self.secret_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod recover_deleted_secret {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/deletedsecrets/{}/recover", &self.secret_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod backup_secret {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/secrets/{}/backup", &self.secret_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::BackupSecretResult>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::BackupSecretResult>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod get_setting {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/settings/{}", &self.setting_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod update_setting {
    ...
    pub struct RequestBuilder {
        pub(crate) client: super::Client,
        pub(crate) setting_name: String,
        pub(crate) parameters: models::UpdateSettingRequest,
    }
    impl RequestBuilder {
        #[doc = "Returns a future that sends the request and returns a [`Response`] object that provides low-level access to full response details."]
        #[doc = ""]
...
pub mod get_settings {
    ...
    pub struct Response(azure_core::Response);
    impl Response {
        pub async fn into_body(self) -> azure_core::Result<models::SettingsListResult> {
            let bytes = self.0.into_body().collect().await?;
            let body: models::SettingsListResult = serde_json::from_slice(&bytes)?;
            Ok(body)
        }
        pub fn into_raw_response(self) -> azure_core::Response {
            self.0
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::SettingsListResult>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::SettingsListResult>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod get_deleted_storage_account {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/deletedstorage/{}", &self.storage_account_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::DeletedStorageBundle>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::DeletedStorageBundle>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod recover_deleted_storage_account {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/deletedstorage/{}/recover", &self.storage_account_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::StorageBundle>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::StorageBundle>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod backup_storage_account {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/storage/{}/backup", &self.storage_account_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::BackupStorageResult>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::BackupStorageResult>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod get_storage_account {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/storage/{}", &self.storage_account_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod regenerate_storage_account_key {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/storage/{}/regeneratekey", &self.storage_account_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod get_sas_definitions {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/storage/{}/sas", &self.storage_account_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod get_deleted_sas_definitions {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            let mut url = self.client.endpoint().clone();
            url.set_path(&format!("/deletedstorage/{}/sas", &self.storage_account_name));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
                    .append_pair(azure_core::query_param::API_VERSION, "7.6-preview.1");
...
pub mod get_deleted_sas_definition {
    ...
    impl RequestBuilder {
        ...
        fn url(&self) -> azure_core::Result<azure_core::Url> {
            ...
            url.set_path(&format!(
                "/deletedstorage/{}/sas/{}",
                &self.storage_account_name, &self.sas_definition_name
            ));
            let has_api_version_already = url.query_pairs().any(|(k, _)| k == azure_core::query_param::API_VERSION);
            if !has_api_version_already {
                url.query_pairs_mut()
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::DeletedSasDefinitionBundle>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::DeletedSasDefinitionBundle>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod recover_deleted_sas_definition {
    ...
    impl std::future::IntoFuture for RequestBuilder {
        type Output = azure_core::Result<models::SasDefinitionBundle>;
        type IntoFuture = BoxFuture<'static, azure_core::Result<models::SasDefinitionBundle>>;
        #[doc = "Returns a future that sends the request and returns the parsed response body."]
        #[doc = ""]
        #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
        #[doc = ""]
...
pub mod role_definitions {
    ...
    impl Client {
        ...
        pub fn get(&self, scope: impl Into<String>, role_definition_name: impl Into<String>) -> get::RequestBuilder {
            get::RequestBuilder {
                client: self.0.clone(),
                scope: scope.into(),
        ...
        pub fn delete(&self, scope: impl Into<String>, role_definition_name: impl Into<String>) -> delete::RequestBuilder {
...
pub mod hsm_security_domain {
    ...
    impl Client {
        ...
        pub fn download_pending(&self) -> download_pending::RequestBuilder {
            download_pending::RequestBuilder { client: self.0.clone() }
        }
        ...
        pub fn download(&self, certificate_info_object: impl Into<models::CertificateInfoObject>) -> download::RequestBuilder {
        ...
        pub fn transfer_key(&self) -> transfer_key::RequestBuilder {
            transfer_key::RequestBuilder { client: self.0.clone() }
        }
        #[doc = "Restore the provided Security Domain."]
        #[doc = ""]
        #[doc = "Arguments:"]
        #[doc = "* `security_domain`: The Security Domain to be restored."]
        pub fn upload(&self, security_domain: impl Into<models::SecurityDomainObject>) -> upload::RequestBuilder {
        ...
        pub fn upload_pending(&self) -> upload_pending::RequestBuilder {
            upload_pending::RequestBuilder { client: self.0.clone() }
        }
    }
    pub mod download_pending {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SecurityDomainOperationStatus> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SecurityDomainOperationStatus = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SecurityDomainOperationStatus>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SecurityDomainOperationStatus>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod download {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::SecurityDomainObject> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::SecurityDomainObject = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SecurityDomainObject>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SecurityDomainObject>>;
            #[doc = "Returns a future that polls the long running operation, returning once the operation completes."]
            #[doc = ""]
            #[doc = "To only submit the request but not monitor the status of the operation until completion, use `send()` instead."]
            #[doc = ""]
    ...
    pub mod transfer_key {
        ...
        impl Response {
            pub async fn into_body(self) -> azure_core::Result<models::TransferKey> {
                let bytes = self.0.into_body().collect().await?;
                let body: models::TransferKey = serde_json::from_slice(&bytes)?;
                Ok(body)
            }
            pub fn into_raw_response(self) -> azure_core::Response {
                self.0
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TransferKey>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::TransferKey>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
